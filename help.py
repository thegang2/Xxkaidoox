...
`.م1` » اعـدادات الـسـورس

`.م2` » اوامـر صـيد الـيـوزرات

`.م3` » اوامـر تـجـميـع نـقـاط بـوتـات الـتـمـويل

`.م4` » اوامـر الـسـورس الاضـافـيـة**
'''
sec1 = '''
`-- -- -- -- -- -- -- -- --`
**سورس الحجي
...
`.تجميع الجوكر` : يقوم بتـجميع نقاط بوت تمويل الجوكر

`.تجميع العقاب` : يقوم بتـجميع نقاط بوت تمويل العقاب

`.تجميع العرب` : يقوم بتـجميع نقاط بوت تمويل العرب

`.تجميع البرليون` : يقوم بتـجميع نقاط بوت تمويل البرليون

`.تجميع اسيا` : يقوم بتـجميع نقاط بوت تمويل اسيا

`.تجميع هايبر` : يقوم بتـجميع نقاط بوت تمويل هايبر

`.تجميع السلطان` : يقوم بتـجميع نقاط بوت تمويل السلطان

✘✘✘✘✘✘✘✘✘✘✘✘✘✘✘✘
"""
sec4 = """
الاوامر الاضافية | الحجي
